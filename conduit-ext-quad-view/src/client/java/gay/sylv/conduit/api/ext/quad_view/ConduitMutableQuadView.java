...
public interface ConduitMutableQuadView<Q extends MutableQuadView> extends ConduitQuadView<Q>, MutableQuadView {
	static ConduitMutableQuadView<MutableQuadView> of(MutableQuadView quad) {
		return (ConduitMutableQuadView<MutableQuadView>) quad;
	}
	...
	default Q spriteBake(TextureAtlasSprite sprite, int bakeFlags) {
		return (Q) MutableQuadView.super.spriteBake(
				sprite,
				bakeFlags
		);
	}
