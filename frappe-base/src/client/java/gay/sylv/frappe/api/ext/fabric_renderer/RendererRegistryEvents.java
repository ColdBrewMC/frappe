...
import gay.sylv.frappe.impl.ext.fabric_renderer.RendererRegistryEventsImpl;

/// Events related to the registration of [net.fabricmc.fabric.api.client.renderer.v1.Renderer] and
/// [gay.sylv.frappe.api.base.extension.RendererExtension]
public final class RendererRegistryEvents {
	...
	/// [gay.sylv.frappe.api.base.extension.RendererExtension] using this callback.
	...
	public interface BeforeRendererRegistry {
		...
		/// before any [gay.sylv.frappe.api.base.extension.RendererExtension] are loaded.
		void beforeRegistry();
	}
}
